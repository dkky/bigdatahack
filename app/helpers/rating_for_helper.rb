module RatingForHelper
  def rating_for(rateable_obj, dimension=nil, options={})
    ...
    if options[:imdb_avg] && readonly
      content_tag :div, '', :style => "background-image:image-url(/assets/mid-star.png);width:61px;height:57px;margin-top:10px;" do
  ...
  def imdb_style_rating_for(rateable_obj, user, options = {})
    ...
    content_tag :div, '', :style => "background-image:image-url(/assets/big-star.png);width:81px;height:81px;margin-top:10px;" do
